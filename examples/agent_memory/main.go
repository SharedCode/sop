...
func main() {
	fmt.Println("================================================================")
	fmt.Println("  ENGRAM AGENT MEMORY ENGINE // AI SWARM STATE PERSISTENCE DEMO")
	fmt.Println("================================================================")
	...
	fmt.Println("    -> [Engram Isolation] Incomplete transaction frame rolled back automatically.")
	fmt.Println("    -> Zero corrupted memory frames persisted to B-Tree.")

	// Step 4: Swarm Failover & Re-assignment
	fmt.Println("\n[4] Engram Swarm Coordinator detects heartbeat lease timeout (12ms)...")
