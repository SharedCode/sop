...
func (s stubPriorityLogRemoveErr) Add(ctx context.Context, tid sop.UUID, payload []byte) error { return nil }
func (s stubPriorityLogRemoveErr) Remove(ctx context.Context, tid sop.UUID) error {
    if tid.String() == s.target { return errors.New("prio remove err") }
    return nil
}
func (s stubPriorityLogRemoveErr) Get(ctx context.Context, tid sop.UUID) ([]sop.RegistryPayload[sop.Handle], error) { return nil, nil }
...
func (s stubPriorityLogRemoveErr) LogCommitChanges(ctx context.Context, stores []sop.StoreInfo, a, b, c, d []sop.RegistryPayload[sop.Handle]) error { return nil }
func (s stubPriorityLogRemoveErr) WriteBackup(ctx context.Context, tid sop.UUID, payload []byte) error { return nil }
...
func (t tlogWithPrioRemoveErr) Add(ctx context.Context, tid sop.UUID, commitFunction int, payload []byte) error { return nil }
...
func (s storeRepoUpdateErr) Add(ctx context.Context, stores ...sop.StoreInfo) error { return s.base.Add(ctx, stores...) }
...
func (s storeRepoUpdateErr) Remove(ctx context.Context, names ...string) error { return s.base.Remove(ctx, names...) }
func (s storeRepoUpdateErr) Replicate(ctx context.Context, storesInfo []sop.StoreInfo) error { return s.base.Replicate(ctx, storesInfo) }
...
func (l logErrTL) Add(ctx context.Context, tid sop.UUID, commitFunction int, payload []byte) error {
    if commitFunction == l.target { return errors.New("log add err") }
    return nil
}
...
func Test_Phase1Commit_LogCommitNewRootNodes_Error_Returns(t *testing.T) {
    ...
    if si.RootNodeID.IsNil() { si.RootNodeID = sop.NewUUID() }
...
func (e errUpdateNoLocksReg2) Add(ctx context.Context, s []sop.RegistryPayload[sop.Handle]) error { return e.inner.Add(ctx, s) }
func (e errUpdateNoLocksReg2) Update(ctx context.Context, s []sop.RegistryPayload[sop.Handle]) error { return e.inner.Update(ctx, s) }
...
func (e errUpdateNoLocksReg2) Remove(ctx context.Context, lids []sop.RegistryPayload[sop.UUID]) error { return e.inner.Remove(ctx, lids) }
