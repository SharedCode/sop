...
func (removeErrTL) Remove(ctx context.Context, tid sop.UUID) error { return fmt.Errorf("forced remove error") }
...
type errIsLockedCache13 struct{ inner sop.Cache; err error }

func (c errIsLockedCache13) Set(ctx context.Context, key, value string, expiration time.Duration) error { return c.inner.Set(ctx, key, value, expiration) }
func (c errIsLockedCache13) Get(ctx context.Context, key string) (bool, string, error) { return c.inner.Get(ctx, key) }
...
func (c errIsLockedCache13) Delete(ctx context.Context, keys []string) (bool, error) { return c.inner.Delete(ctx, keys) }
...
func (c errIsLockedCache13) CreateLockKeys(keys []string) []*sop.LockKey { return c.inner.CreateLockKeys(keys) }
...
func (c errIsLockedCache13) Unlock(ctx context.Context, lockKeys []*sop.LockKey) error { return c.inner.Unlock(ctx, lockKeys) }
...
type errGetExCache13 struct{ inner sop.Cache; err error }

func (c errGetExCache13) Set(ctx context.Context, key, value string, expiration time.Duration) error { return c.inner.Set(ctx, key, value, expiration) }
func (c errGetExCache13) Get(ctx context.Context, key string) (bool, string, error) { return c.inner.Get(ctx, key) }
...
func (c errGetExCache13) Delete(ctx context.Context, keys []string) (bool, error) { return c.inner.Delete(ctx, keys) }
...
func (c errGetExCache13) CreateLockKeys(keys []string) []*sop.LockKey { return c.inner.CreateLockKeys(keys) }
...
func (c errGetExCache13) IsLocked(ctx context.Context, lockKeys []*sop.LockKey) (bool, error) { return c.inner.IsLocked(ctx, lockKeys) }
func (c errGetExCache13) IsLockedByOthers(ctx context.Context, lockKeyNames []string) (bool, error) {
    return c.inner.IsLockedByOthers(ctx, lockKeyNames)
}
func (c errGetExCache13) Unlock(ctx context.Context, lockKeys []*sop.LockKey) error { return c.inner.Unlock(ctx, lockKeys) }
...
func (p plGetErr) Get(ctx context.Context, tid sop.UUID) ([]sop.RegistryPayload[sop.Handle], error) { return nil, p.e }
...
type plRemoveErr struct{ payload []sop.RegistryPayload[sop.Handle]; e error }
...
func (p plRemoveErr) Get(ctx context.Context, tid sop.UUID) ([]sop.RegistryPayload[sop.Handle], error) { return p.payload, nil }
...
func (e errStoreRepo2) Add(ctx context.Context, stores ...sop.StoreInfo) error { return e.inner.Add(ctx, stores...) }
...
func (e errStoreRepo2) Remove(ctx context.Context, names ...string) error { return e.inner.Remove(ctx, names...) }
