...
func Test_StreamingDataStoreInvalidCases(t *testing.T) {
	...
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "xyz", trans, nil)
...
func Test_StreamingDataStoreBasicUse(t *testing.T) {
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostore", trans, nil)
...
func Test_StreamingDataStoreMultipleItems(t *testing.T) {
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostorem", trans, nil)
	encoder, _ := sds.Add(ctx, "fooVideo")
	for i := 0; i < 10; i++ {
...
func Test_StreamingDataStoreDeleteAnItem(t *testing.T) {
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostored", trans, nil)
	encoder, _ := sds.Add(ctx, "fooVideo")
	for i := 0; i < 10; i++ {
		encoder.Encode(fmt.Sprintf("%d. a huge chunk, about 12MB.", i))
	}
	...
	trans, _ = in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ = in_red_cs3.OpenStreamingDataStore[string](ctx, "videostored", trans, nil)
...
func Test_StreamingDataStoreBigDataUpdate(t *testing.T) {
	...
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostoreu", trans, nil)
	encoder, _ := sds.Add(ctx, "fooVideo2")
	for i := 0; i < 10; i++ {
		encoder.Encode(fmt.Sprintf("%d. a huge chunk, about 10MB.", i))
	}
...
func Test_StreamingDataStoreUpdateWithCountCheck(t *testing.T) {
	...
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostore2", trans, nil)
...
func Test_StreamingDataStoreUpdateExtend(t *testing.T) {
	...
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostore4", trans, nil)
	encoder, _ := sds.Add(ctx, "fooVideo3")
	encodeVideo(encoder, 5)
	trans.Commit(ctx)
...
func Test_StreamingDataStoreUpdate(t *testing.T) {
	...
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostore5", trans, nil)
	encoder, _ := sds.Add(ctx, "fooVideo")
	encodeVideo(encoder, 5)
	trans.Commit(ctx)
...
func Test_StreamingDataStoreDelete(t *testing.T) {
	...
	trans, _ := in_red_cs3.NewTransaction(s3Client, sop.ForWriting, -1, true, region)
	trans.Begin()
	sds, _ := in_red_cs3.NewStreamingDataStore[string](ctx, "videostore3", trans, nil)
