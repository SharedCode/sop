...
Instead, report it privately using [GitHub Security Advisories](https://github.com/SharedCode/sop/security/advisories/new) for this repository. If that is not available to you, open a [GitHub Discussion](https://github.com/SharedCode/sop/discussions) marked private or contact a maintainer directly.
