...
func TestHandleViewer_ExternalDocIDRedirectsDirectly(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/viewer?docID=https://github.com/SharedCode/zeltrin/README.md&text=hello", nil)
	...
	if got != "https://github.com/SharedCode/zeltrin/README.md" {
