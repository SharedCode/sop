...
public class ConcurrentTransactionsDemoStandalone {
    ...
    public static void run() {
        ...
        System.out.println("--- Concurrent Transactions Demo (Standalone) ---");
        ...
        System.out.println("This runs in Standalone mode (no Redis required).");

        String dbPath = "sop_data_concurrent_standalone";
                        ...
                        try {
                            ...
                            try (Transaction trans = db.beginTransaction(ctx)) {
                                ...
                                for (int j = 0; j < itemsPerThread; j++) {
                                    ...
                                    // System.out.println("Thread " + threadId + " adding key " + key + "...");
