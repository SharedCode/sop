...
def main():
    print("--- Full Replication Config Demo ---")
    ...
    try:
        ...
        ctx = Context()
        db_path = "data/full_repl_demo"

        stores_folders = [db_path + "/d1", db_path + "/d2"]
        ec = {
            "": ErasureCodingConfig(
                data_shards_count=1,
                parity_shards_count=1,
                base_folder_paths_across_drives=stores_folders
            )
        }
    ...
    print("--- End of Full Replication Demo ---")
