...
func (itemSer *ItemSerializer) IsValid() bool {
	if itemSer.CompareKey == nil {
		return false
	}
	// Key
	if itemSer.StringSerializeKey != nil {
		if itemSer.StringDeSerializeKey == nil {
			return false
		}
	} else if itemSer.SerializeKey != nil {
		if itemSer.DeSerializeKey == nil {
			return false
		}
	} else {
		return false
	...
	if itemSer.StringSerializeValue != nil {
		if itemSer.StringDeSerializeValue == nil {
			return false
		}
	} else if itemSer.SerializeValue != nil {
		if itemSer.DeSerializeValue == nil {
			return false
		}
	} else {
		return false
