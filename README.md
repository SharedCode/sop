...
## As a general purpose DB engine
  ...
  * Many Writers, many Readers - this setup can be slow as you are exposed to having conflicting transactions and data merges. BUT if you organized the transactions in a way that there is minimal or zero conflict per data being submitted across them, then you can achieve a very decent/great performance considering you are benefiting from ACID transactions, thus achieving higher data quality.
