...
func init() {
	Register("perceptron", func(cfg map[string]any) (port.Generator, error) {
...
func (p *perceptron) Generate(ctx context.Context, prompt string, opts port.GenOptions) (port.GenOutput, error) {
