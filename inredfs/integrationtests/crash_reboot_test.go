...
func Test_CrashReboot(t *testing.T) {
	...
	s1, err := inredfs.NewBtreeWithReplication[string, string](ctx, sop.StoreOptions{
		Name:       storeName,
		SlotLength: 10,
	...
	// Open the same store.
	s2, err := inredfs.NewBtreeWithReplication[string, string](ctx, sop.StoreOptions{
		Name:       storeName,
		SlotLength: 10,
	...
	s3, err := inredfs.NewBtreeWithReplication[string, string](ctx, sop.StoreOptions{
		Name:       storeName,
		SlotLength: 10,
	...
	s4, err := inredfs.NewBtreeWithReplication[string, string](ctx, sop.StoreOptions{
		Name:       storeName,
		SlotLength: 10,
	...
	s5, err := inredfs.NewBtreeWithReplication[string, string](ctx, sop.StoreOptions{
		Name:       storeName,
		SlotLength: 10,
