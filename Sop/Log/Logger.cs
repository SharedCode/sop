...
namespace Sop.Log
{
    ...
    public class Logger : ILogger, IDisposable
    {
        ...
        public void Dispose()
        {
            if (RealLogger != null && RealLogger is IDisposable)
            {
                ((IDisposable)RealLogger).Dispose();
                RealLogger = null;
            }
        }
        ...
        public LogLevels? LogLevel
        {
            get
            {
                return RealLogger.LogLevel;
            }
            set
            {
                RealLogger.LogLevel = value;
            }
        }
        ...
        {
            if (RealLogger == null) return false;
