...
namespace Sop.Client
{
    ...
    {
        /// <summary>
        /// Returns count of items in this Dictionary.
        /// </summary>
        long Count { get; }
        /// <summary>
        ...
        /// <summary>
        /// true will prevent add of item with duplicate key in the Store,
        /// otherwise duplicate is allowed. Defaults to false.
        /// </summary>
        bool IsUnique { get; }
    ...
    public interface ISortedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ISortedDictionary
    {
        new long Count { get; }
        /// <summary>
        /// Add an entry if its key doesn't exist yet in this dictionary.
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        bool AddIfNotExist(TKey key, TValue value);
        /// <summary>
        ...
        ///// <summary>
        ///// Returns the current entry (key and value pair).
        ///// </summary>
