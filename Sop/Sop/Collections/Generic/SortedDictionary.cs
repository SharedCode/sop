...
namespace Sop.Collections.Generic
{
    ...
    public class SortedDictionary<TKey, TValue> : ISortedDictionary<TKey, TValue>
    {
        ...
        {
            get { return _keys ?? (_keys = new BTree.BTreeKeys<TKey, TValue>(this)); }
        }
        ...
        {
            get { return _values ?? (_values = new BTree.BTreeValues<TKey, TValue>(this)); }
        }
        ...
        public System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<TKey, TValue>>
            GetEnumerator()
        {
