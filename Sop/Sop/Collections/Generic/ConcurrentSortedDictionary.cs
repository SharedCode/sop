...
namespace Sop.Collections.Generic
{
    ...
    internal class ConcurrentSortedDictionary<TKey, TValue> : ISortedDictionary<TKey, TValue>
    {
        ...
        public System.Collections.Generic.ICollection<TKey> Keys
        {
            ...
            {
                Locker.Lock();
                var r = _keys ?? (_keys = new BTree.BTreeKeys<TKey, TValue>(this));
                Locker.Unlock();
                return r;
            }
        }
        ...
        public System.Collections.Generic.ICollection<TValue> Values
        {
            ...
            {
                Locker.Lock();
                var r =_values ?? (_values = new BTreeValues<TKey, TValue>(this));
                Locker.Unlock();
                return r;
            }
        }
        ...
        public KeyValuePair<TKey, TValue>? CurrentEntry
        {
            get
            {
                Locker.Lock();
                var r = Btree.CurrentEntry != null
                           ? (KeyValuePair<TKey, TValue>?)new KeyValuePair<TKey, TValue>(Btree.CurrentEntry.Key, Btree.CurrentEntry.Value)
                           : null;
                Locker.Unlock();
                return r;
            }
