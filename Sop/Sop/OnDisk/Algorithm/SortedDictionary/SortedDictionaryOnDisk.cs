...
namespace Sop.OnDisk.Algorithm.SortedDictionary
{
    ...
    internal partial class SortedDictionaryOnDisk : ISortedDictionaryOnDisk, IInternalFileEntity
    {
        ...
        {
            get { return BTreeAlgorithm == null; }
            set { }
        }
        ...
        {
            get { return BTreeAlgorithm.CurrentSequence; }
            set { BTreeAlgorithm.CurrentSequence = value; }
        }
        ...
        {
            return BTreeAlgorithm.GetNextSequence();
        }
        ...
        public void Clear()
        {
            ...
            if (Count > 0)
            {
                ...
                long endSegmentAddress = dbi.StartBlockAddress + (int) DataBlockSize*f.Profile.CollectionGrowthSizeInNob;
                ...
                b3.HeaderData.EndAllocatableAddress = dbi.StartBlockAddress +
                                                      (short) DataBlockSize*f.Profile.CollectionGrowthSizeInNob;
        ...
        public override string ToString()
        {
            ...
            UniqueStoreName = string.Format("{0}\\{1}", File.Filename, this.Name);
        ...
        {
            get { return _syncRoot ?? (_syncRoot = BTreeAlgorithm.SyncRoot); }
            private set { BTreeAlgorithm.SyncRoot = value; }
        }
        ...
        public string Name
        {
            get { return BTreeAlgorithm.Name; }
