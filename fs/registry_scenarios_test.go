...
func (t testLockFail) IsRestarted(ctx context.Context) (bool, error) { return false, nil }
...
func (t testAllLock) IsRestarted(ctx context.Context) (bool, error) { return false, nil }
