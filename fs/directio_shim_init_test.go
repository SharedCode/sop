...
func (dio directIOShim) WriteAt(ctx context.Context, f *os.File, b []byte, off int64) (int, error) {
	return f.WriteAt(b, off)
}
func (dio directIOShim) ReadAt(ctx context.Context, f *os.File, b []byte, off int64) (int, error) {
